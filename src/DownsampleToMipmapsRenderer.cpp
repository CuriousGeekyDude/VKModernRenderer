...
{
	DownsampleToMipmapsRenderer::DownsampleToMipmapsRenderer(VulkanEngine::VulkanRenderContext& l_vkContextCreator
	...
	void DownsampleToMipmapsRenderer::FillCommandBuffer(VkCommandBuffer l_cmdBuffer,
	...
	void DownsampleToMipmapsRenderer::UpdateBuffers(const uint32_t l_currentSwapchainIndex,
	...
	void DownsampleToMipmapsRenderer::UpdateDescriptorSets()
	{
	...
	DownsampleToMipmapsRenderer::~DownsampleToMipmapsRenderer()
	{
